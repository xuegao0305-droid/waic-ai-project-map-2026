...
function renderPolicy(filter=selectedPolicyFilter,caseFilter=selectedCaseFilter){
  ...
  $("#policy").innerHTML=intro("WAIC 2026政策与项目","29国合作、八项行动、十大国际案例与上海409亿元项目集中落地","政策、国际组织、领导人合作举措、研究报告、企业方案和项目投资分别标注，32项签约项目按公开程度展开")+
  ...
  '<section class="signed-project-section"><div class="section-title"><span>上海32项签约明细</span><h2>公开信息能确认7个项目名和2家签约企业，其余23项名称尚未公布</h2><p>32项投资总额超过409亿元，覆盖AI基础设施、智能体应用、具身智能和科学智能</p></div><div class="signed-project-hero"><div class="signed-total"><article><span>签约项目</span><b>'+signed.total+'项</b><small>上海市级公开总数</small></article><article><span>投资总额</span><b>'+esc(signed.amount)+'</b><small>未公布逐项金额</small></article></div><div class="signed-disclosure"><span>公开明细现状 · '+esc(signed.asOf)+'</span><h3>'+esc(signed.disclosure)+'</h3><div><b>'+signed.confirmedProjects.length+'项</b><small>项目名明确</small><b>'+signed.identifiedParticipants.length+'家</b><small>签约企业明确</small><b>'+signed.unpublishedCount+'项</b><small>名称尚未公开</small></div><a href="'+esc(signed.officialSource)+'" target="_blank" rel="noreferrer">上海市级总口径 ↗</a></div></div><div class="signed-area-grid">'+signed.areas.map((x,i)=>'<article><i>'+String(i+1).padStart(2,"0")+'</i><h3>'+esc(x.name)+'</h3><p>'+esc(x.description)+'</p></article>').join("")+'</div>'+
